...
import { Card, CardContent, Box, IconButton, Button, Typography } from '@mui/material';
  ...
  return (
    ...
    >
      <Box sx={{ 
        ...
        <Typography variant="body2" color="textSecondary">Изображение недоступно</Typography>
      </Box>
      <CardContent sx={{ p: 2 }}>
...
const OfferCard = memo(({ offer = {}, isFavorite = false, onFavoriteClick = () => {} }) => {
