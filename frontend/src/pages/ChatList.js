    ...
    useEffect(() => {
        const fetchRequests = async () => {
            try {
                ...
                const userRes = await axios.get('http://localhost:5001/api/services/my-requests', {
                    headers: {
                ...
                const providerRes = await axios.get('http://localhost:5001/api/services/provider-offers', {
                    headers: {
                        Authorization: `Bearer ${token}`,
                    },
                });
